          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="relative w-28 h-28 flex items-center justify-center">
              ...
              >
                ...
                <path d="M8 52 L28 36 L42 48 L54 38 L72 52" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
              </svg>
            </div>
            <p className="p-16-medium text-gray-400 dark:text-slate-500">No recent projects found</p>
          </div>
        </div>
      )}
